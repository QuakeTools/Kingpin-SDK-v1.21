...
{
	ai_charge,	  0.000, punk_firehmg,	// frame 0
	ai_charge,	  0.000, punk_firehmg,	// frame 1
	ai_charge,	  0.000, punk_firehmg,	// frame 2
	ai_charge,	  0.000, NULL,	// frame 3
	ai_charge,	  0.000, punk_firehmg_delay,	// frame 4
};
...
mframe_t	punk_frames_bazooka_shoot[] = 
{
	...
	ai_charge,	  0.000, NULL,	// frame 3
	ai_charge,	  0.000, punk_firebazooka_delay,	// frame 4
};
...
mmove_t	punk_move_crouch_stand_down = {FRAME_stand_crouch_02, FRAME_stand_crouch_04, punk_frames_crouch_stand_down, AI_End_CrouchStand_Down};
...
mmove_t	punk_move_crouch_stand_up = {FRAME_stand_crouch_04, FRAME_stand_crouch_02, punk_frames_crouch_stand_up, AI_End_CrouchStand_Up};
...
mmove_t	punk_move_clmb_loop = {FRAME_clmb_loop_01, FRAME_clmb_loop_09, punk_frames_clmb_loop, AI_CheckStillClimbingLadder};
...
{
	ai_turn,	  11.306, punk_firehmg,	// frame 0
	ai_turn,	   6.486, punk_firehmg,	// frame 1
	ai_turn,	   6.159, punk_firehmg,	// frame 2
	...
	ai_turn,	   5.740, punk_firehmg_delay,	// frame 9
};
...
{
	ai_charge,	 27.656, punk_firehmg,	// frame 0
	ai_charge,	 17.929, punk_firehmg,	// frame 1
	ai_charge,	 33.470, punk_firehmg,	// frame 2
	ai_charge,	 37.084, NULL,	// frame 3
	ai_charge,	 31.857, NULL,	// frame 4
	ai_charge,	 24.969, punk_firehmg_delay,	// frame 5
};
...
{
	ai_charge,-	 24.969, punk_firehmg,	// frame 5
	ai_charge,-	 31.857, punk_firehmg,	// frame 4
	ai_charge,-	 37.084, punk_firehmg,	// frame 3
	ai_charge,-	 33.470, NULL,	// frame 2
	ai_charge,-	 17.929, NULL,	// frame 1
	ai_charge,-	 27.656, NULL,	// frame 0
};
...
mmove_t	punk_move_run_reverse_flamegun_sht = {FRAME_run_tg_sht_06, FRAME_run_tg_sht_01, punk_frames_run_reverse_flamegun_sht, AI_EndAttack};
...
mframe_t	punk_frames_hmg_shoot2[] = 
{
	ai_charge,	  0.000, NULL,	// frame 0
	ai_charge,	  0.000, NULL,	// frame 1
	ai_charge,	  0.000, punk_hmg_avoid,	// frame 2
};
mmove_t	punk_move_hmg_shoot2 = {FRAME_hmg_std_01, FRAME_hmg_std_03, punk_frames_hmg_shoot2, AI_EndAttack};

mframe_t	punk_frames_walk_hmg_sht2[] = 
{
	ai_turn,	   5.738, NULL,	// frame 0
	ai_turn,	   6.106, NULL,	// frame 1
	ai_turn,	   2.718, NULL,	// frame 2
	ai_turn,	  15.227, NULL,	// frame 3
	ai_turn,	   8.520, NULL,	// frame 4
	ai_turn,	   8.156, NULL,	// frame 5
	ai_turn,	   8.786, NULL,	// frame 6
	ai_turn,	   8.167, NULL,	// frame 7
	ai_turn,	   4.561, NULL,	// frame 8
	ai_turn,	   8.200, punk_hmg_avoid,	// frame 9
};
mmove_t	punk_move_walk_hmg_sht2 = {FRAME_hmg_wlk_01, FRAME_hmg_wlk_10, punk_frames_walk_hmg_sht2, AI_EndAttack};

mframe_t	punk_frames_run_hmg_sht2[] = 
{
	ai_charge,	 26.196, NULL,	// frame 0
	ai_charge,	 16.246, NULL,	// frame 1
	ai_charge,	 33.745, NULL,	// frame 2
	ai_charge,	 39.112, NULL,	// frame 3
	ai_charge,	 31.627, NULL,	// frame 4
	ai_charge,	 25.468, punk_hmg_avoid,	// frame 5
};
mmove_t	punk_move_run_hmg_sht2 = {FRAME_hmg_run_01, FRAME_hmg_run_06, punk_frames_run_hmg_sht2, AI_EndAttack};

mframe_t	punk_frames_bazooka_shoot2[] = 
{
	ai_charge,	  0.000, NULL,	// frame 0
	ai_charge,	  0.000, NULL,	// frame 1
	ai_charge,	  0.000, NULL,	// frame 2
...
mmove_t	punk_move_bazooka_shoot2 = {FRAME_hmg_std_01, FRAME_hmg_std_06, punk_frames_bazooka_shoot2, AI_EndAttack};

mframe_t	punk_frames_walk_bazooka_shoot2[] = 
{
	ai_turn,	   5.738, NULL,	// frame 0
	ai_turn,	   6.106, NULL,	// frame 1
	ai_turn,	   2.718, NULL,	// frame 2
	...
	ai_turn,	   8.167, NULL,	// frame 7
	ai_turn,	   4.561, NULL,	// frame 8
	ai_turn,	   8.200, NULL,	// frame 9
};
mmove_t	punk_move_walk_bazooka_shoot2 = {FRAME_hmg_wlk_01, FRAME_hmg_wlk_10, punk_frames_walk_bazooka_shoot2, AI_EndAttack};

mframe_t	punk_frames_run_bazooka_shoot2[] = 
{
	ai_charge,	 26.196, NULL,	// frame 0
	ai_charge,	 16.246, NULL,	// frame 1
	ai_charge,	 33.745, NULL,	// frame 2
	ai_charge,	 39.112, NULL,	// frame 3
	ai_charge,	 31.627, NULL,	// frame 4
	ai_charge,	 25.468, NULL,	// frame 5
};
mmove_t	punk_move_run_bazooka_shoot2 = {FRAME_hmg_run_01, FRAME_hmg_run_06, punk_frames_run_bazooka_shoot2, AI_EndAttack};
